...
class EmployeeFilter(django_filters.FilterSet):
    only_corporate = django_filters.BooleanFilter(
        field_name='user__is_corporate_account',
        label='Is corporate account',
    )

    can_be_group_manager = django_filters.BooleanFilter(
        method='can_be_group_manager_filter',
        label='Can be group manager',
    )
    ...
    @staticmethod
    def can_be_group_manager_filter(queryset):
...
class OfferOrgFilter(django_filters.FilterSet):
    ...
    def decision_filter(self, queryset, value):
